 ...
 */
export const updateFolder = asyncHandler(async (req: Request, res: Response): Promise<void> => {
 ...
 * @returns {Promise<void>} - Sends the response with the result of the folder update.
 */
export const editFolder = asyncHandler(async (req: Request, res: Response): Promise<void> => {
 ...
 */
export const getFolderById = asyncHandler(async (req: Request, res: Response): Promise<void> => {
 ...
 */
export const getAllFolders = asyncHandler(async (req: Request, res: Response): Promise<void> => {
